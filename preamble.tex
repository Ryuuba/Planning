...
\usepackage{sectsty}
    ...
    \sectionfont{\color{Wolf}\fontsize{12}{11}\selectfont}
...
\renewcommand{\abstractname}{\flushleft \textcolor{Xoc}{Resumen}} % Uncomment to change the name of the abstract to something else
